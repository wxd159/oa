            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-6">${leaveInfo.reason}</div>
                    </div>
                    <div class="section row">
                        <div class="col-md-2">创建人</div>
                        <div class="col-md-4">${leaveInfo.creater.name}</div>
                        <div class="col-md-2">创建时间</div>
                        <div class="col-md-4"><spring:eval expression="leaveInfo.createTime"/></div>
                    </div>
                    <div class="section row">
                        <div class="col-md-2">开始时间</div>
                        <div class="col-md-4"><spring:eval expression="leaveInfo.startTime"/></div>
                        <div class="col-md-2">结束时间</div>
                        <div class="col-md-4"><spring:eval expression="leaveInfo.endTime"/></div>
                    </div>
                    <div class="section row">
                        <div class="col-md-2">待处理人</div>
                        <div class="col-md-4">${leaveInfo.dealer.name}</div>
                        <div class="col-md-2">状态</div>
                        <div class="col-md-4">${leaveInfo.status}</div>
                    </div>
                    <div class="section-divider mt20 mb40">
                        <span> 处理流程 </span>
                    </div>
                    ...
                    <form:form id="admin-form" name="addForm" action="/leaveInfo/check" modelAttribute="record">
