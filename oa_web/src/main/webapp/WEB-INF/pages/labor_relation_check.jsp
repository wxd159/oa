            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-4">${labor_relation.item}</div>
                        <div class="col-md-2">事由</div>
                        <div class="col-md-4">${labor_relation.cause}</div>
                    </div>
                    <div class="section row">
                        <div class="col-md-2">创建人</div>
                        <div class="col-md-4">${labor_relation.creater.name}</div>
                        <div class="col-md-2">创建时间</div>
                        <div class="col-md-4"><spring:eval expression="labor_relation.createTime"/></div>
                    </div>
                    <div class="section row">
                        <div class="col-md-2">待处理人</div>
                        <div class="col-md-4">${labor_relation.dealer.name}</div>
                        <div class="col-md-2">状态</div>
                        <div class="col-md-4">${labor_relation.status}</div>
                    </div>
                    <div class="section-divider mt20 mb40">
                        <span> 处理流程 </span>
                    </div>
                    ...
                    <form:form id="admin-form" name="addForm" action="/labor_relation/check" modelAttribute="record">
                        <form:hidden path="laborRelationId" />
                        <div class="panel-body bg-light">
                            <div class="section">
