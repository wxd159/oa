        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form action="/employee/update" modelAttribute="employee"  id="admin-form" name="addForm">
                    ...
                    <form:hidden path="registrantSn"/>
                    <form:hidden path="departmentSn"/>
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="name" class="field prepend-icon">
                                    <form:input path="department.name" temLabel="name" cssClass="gui-input" placeholder="所属部门..." readonly="true"/>
                                    <label for="name" class="field-icon">
                                        <i class="fa fa-user"></i>
                                    </label>
                                </label>
                            ...
                            <div class="col-md-6">
                                <label for="post" class="field prepend-icon">
                                    <form:input path="post"  cssClass="gui-input" placeholder="职务..." readonly="true"/>
                                    <label for="name" class="field-icon">
                                        <i class="fa fa-user"></i>
                                    </label>
                                </label>
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="birthday" class="field prepend-icon">
                                    <form:input path="birthday" cssClass="gui-input" placeholder="出生年月..." />
                            ...
                            <div class="col-md-6">
                                <label for="baseSalary" class="field prepend-icon">
                                    <form:input path="baseSalary" class="gui-input" placeholder="基本工资..." readonly="true"/>
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="school" class="field prepend-icon">
                                    <form:input path="startDate" cssClass="gui-input" placeholder="合同生效日期..." readonly="true"/>
                                    <label for="school" class="field-icon">
                                        <i class="fa fa-user"></i>
                                    </label>
                                </label>
                            ...
                            <div class="col-md-6">
                                <label for="degree" class="field prepend-icon">
                                    <form:input path="endDate" class="gui-input" placeholder="合同终止日期..." readonly="true"/>
                                    <label for="degree" class="field-icon">
                                        <i class="fa fa-user"></i>
                                    </label>
                                </label>
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="school" class="field prepend-icon">
                                    <form:input path="status" cssClass="gui-input" placeholder="状态..." readonly="true"/>
                                    <label for="school" class="field-icon">
                                        <i class="fa fa-user"></i>
                                    </label>
                                </label>
